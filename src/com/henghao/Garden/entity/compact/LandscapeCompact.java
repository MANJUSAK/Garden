 ...
 */
@Entity
@Table(name = "landscapeCompact", catalog = "garden")
public class LandscapeCompact implements java.io.Serializable {
	 ...
	 * 接受者姓名 private String recipientName; // 接受者手机号 private String
	 * recipientTel; // 接受者id private String recipientId; // 发起合同状态（0表示发起或1表示接受）
	...
	/** full constructor */
	public LandscapeCompact(Integer id, String compactId, String uid,
			String pictureId, String genre, String projectName, String dates,
	 ...
	 * 
	 * @Column(name = "recipient", length = 20) public String getRecipientName()
