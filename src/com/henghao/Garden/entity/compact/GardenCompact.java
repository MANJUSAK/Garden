...
/**
 * GhCompact entity. 园林类合同实体类
 * 
 * @author 严彬荣
 */
@Entity
@Table(name = "gardenCompact", catalog = "garden")
public class GardenCompact implements java.io.Serializable {
	...
	/** full constructor */
	public GardenCompact(Integer id, String compactId, String uid,
