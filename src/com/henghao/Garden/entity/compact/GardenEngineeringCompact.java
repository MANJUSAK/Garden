...
/**
 * GhCompact entity. 园林工程合同实体类
 * 
 * @author 严彬荣
 */
@Entity
@Table(name = "gardenEngineeringCompact", catalog = "garden")
public class GardenEngineeringCompact implements java.io.Serializable {
	 ...
	 * // 接受者手机号 private String recipientTel; // 发起合同状态（0表示发起或1表示接受） private
	 * Integer opens;
	 */
	// 审核状态参数
	...
	/** default constructor */
	public GardenEngineeringCompact() {
		this.parameter = 1;
		this.isNo = 0;
	...
	/** full constructor */
	public GardenEngineeringCompact(Integer id, String compactId,
			String projectName, String uid, String pictureId, String genre,
			String dates, String checking, Integer parameter, String comment,
			Integer isNo, List<Compactmassage> url) {
		super();
		this.id = id;
