...
/**
 * function 项目管理信息保存模块访问数据库接口Java接口类
 * <p>
 * date 2017.03.12
 *
 * @author 严彬荣
 */
public interface SaveProjectManageDao {
    // 保存我的轨迹数据信息dao接口
    ...
    // 添加施工安全日志信息数据dao接口
    public void saveConstructionSafetyLogMsgDao(ConstructionSafetyLog msg) throws Exception;
}
