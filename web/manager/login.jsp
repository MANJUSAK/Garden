	...
	<header>
		<div class="header-topbar">
			<div class="ht-box">
				<div class="logo">
					<div class="logo-img">
						<a href="<%=basePath%>news/login.html"><img
					...
					<div class="ls-left-topbar" id="ls-left-topbar_left">
						<div class="ls-lt-container">
							...
							<div style="width: 300px; height: 25px;">
								<font face="微软雅黑" size=3 color="red">${msg }</font> <font
									face="微软雅黑" size=3 color="green">${tip }</font>
							</div>
							...
							<div class="ls-left-footer">
								<span></span><span><a
									href="<%=basePath%>news/register.html">立即注册</a></span>
							</div>
						</div>
					</div>
				</form>
